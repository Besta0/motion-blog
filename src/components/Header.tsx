      ...
      <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <motion.button
            ...
            whileTap={{ scale: 0.92 }}
            onClick={toggleTheme}
            className="w-9 h-9 rounded-lg bg-surface-lighter/50 border border-surface-lighter flex items-center justify-center text-text-secondary hover:text-text-primary hover:border-accent/30 transition-all"
